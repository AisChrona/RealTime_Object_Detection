...
window = Tk()
window.title("Object Detection Camera")
window.iconphoto(False, PhotoImage(file='security-camera.png'))
window.geometry('800x500')

mainFrame = Frame(window, bd=2)

label_title = Label(mainFrame, text = "Object Detection Camera", font=('Helvitica', 40, 'bold'))
label_title.grid(pady=(10,10), column=2)

icon_1 = Image.open('object.png')
icon_1 = icon_1.resize((140, 140),Image.ANTIALIAS)
...
# btn=Button(mainFrame, text="  Start Camera 1",font=('Helvitiva', 20, 'bold'), height=75, width=320, fg='green', image=btn_image, compound='left', bg='lightblue')
# btn.grid(row=2, pady=(20,10), column=2)

btn=Button(mainFrame, text="  Start Camera",font=('Helvitiva', 20, 'bold'), height=75, width=320, fg='green', image=btn_image, compound='left', bg='lightblue', command=object_detector)
